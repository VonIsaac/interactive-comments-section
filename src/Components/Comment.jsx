...
export default function Comment({comments, reply, onDelete}){
                    ...
                    <div className='border-0 border-slate-950 w-[73%] p-4 mb-4 bg-slate-100 rounded-xl ml-10'>
                        ...
                        <li key={replycomment.id}>
                            <div  className='flex gap-4 mb-2'>
                                ...
                                <button onClick={() => onDelete(replycomment.id)} className=' ml-auto font-bold mb-3 cursor-pointer text-rose-700  hover:text-slate-950'>Delete</button>
                            </div>
